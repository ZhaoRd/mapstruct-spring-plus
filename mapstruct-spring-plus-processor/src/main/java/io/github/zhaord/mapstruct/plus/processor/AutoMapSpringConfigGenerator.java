...
import static io.github.zhaord.mapstruct.plus.processor.Const.ANNOTATIONS_PACKAGE;
...
public class AutoMapSpringConfigGenerator {
    ...
    private AnnotationSpec buildGeneratedMapperConfigAnnotationSpec() {
        ClassName autoMapperAdapterClass = ClassName.get(Const.BASE_PACKAGE,
                "AutoMapMapperAdapter");
    ...
    private AnnotationSpec buildGeneratedSpringMapperConfigAnnotationSpec() {
        ...
        return AnnotationSpec.builder(
                ClassName.get(ANNOTATIONS_PACKAGE, "AutoMapSpring"))
                .addMember("autoMapSpringAdapterPackage", "$S", Const.BASE_PACKAGE)
                .addMember("autoMapSpringBeanName", "$S", "AutoMapMapperAdapter")
                .build();
    }
